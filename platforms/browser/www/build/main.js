...
let ListPage = class ListPage {
    constructor(navCtrl, navParams, modalCtrl, toastCtrl, loadingCtrl, ms1Service, ms4Service, keyboard, platform, 
        ...
        this.placeHolder = "Search By Chef Name";
        //       },1);
...
let CheckoutPage = class CheckoutPage {
    constructor(nav, navCtrl, navParams, toastCtrl, loadingCtrl, ms1Service, ms3Service, ms4Service, events, lf, modalCtrl) {
        ...
        this.orderdetails.total = (parseFloat(this.orderdetails.addOnTotal) + parseFloat(this.orderdetails.subtotal)).toFixed(2);
    ...
    CheckingTimeValidationForFirst(init) {
        ...
        if (FirstStartTime.isBefore(ActualTime) && ActualTime.isBefore(FirstEndTime)) {
    ...
    CheckingTimeValidationForSecond(init) {
        ...
        let ActualTime = __WEBPACK_IMPORTED_MODULE_5_moment___default()(this.convertTime12to24(init.value), 'hh:mm');
        if (SecondStartTime.isBefore(ActualTime) && ActualTime.isBefore(SecondEndTime)) {
    ...
    changeMinMaxOfWeekend(deliverySlot, init) {
        ...
        if ((StartTime.isBefore(ActuallTime) || StartTime == ActuallTime) && (ActuallTime.isBefore(EndTime) || ActuallTime == EndTime)) {
    ...
    onChangeDeliveryTye() {
        ...
        if (this.deliveryType == 'pick') {
            this.deliveryCharges = 0;
            this.orderdetails.deliveryCharges = 0;
            this.orderdetails.total = (parseFloat(this.orderdetails.addOnTotal) + parseFloat(this.orderdetails.subtotal));
            this.TaxPrices = (parseFloat(this.orderdetails.total) / 100) * parseFloat(this.orderdetails.tax);
    ...
    firstCall() {
        var time = new Date();
        time.setDate(time.getDate() + this.proOrderBefore);
    ...
    laterFunction(type) {
        if (this.event.laterDay != '' && this.event.laterTime != '') {
            this.orderTime['datetime'] = this.event.laterDay + ' ' + this.event.laterTime;
    ...
    orderTimeFunction() {
        ...
        if (time == 'now') {
            ...
            this.orderTime['datetime'] = this.getFormattedDate(newDate);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_angularfire2_database__ = __webpack_require__(76);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_firebase__ = __webpack_require__(104);
...
let OrderDetailPage = class OrderDetailPage {
    constructor(navCtrl, toastCtrl, ms1Service, ms4Service, alertCtrl, modalCtrl, events, loadingCtrl, navParams, afd) {
        ...
        this.firestore = __WEBPACK_IMPORTED_MODULE_8_firebase___default.a.database().ref('/orders');
        this.datesArray = [];
        this.firebaseOrders = [];
        ...
        this.ms4Service.checkRestroRating(obj).subscribe((presetRating) => {
            if (!presetRating.error) {
                if (presetRating.message.length > 0) {
                    ...
                    if (type == 'whenrated') {
                        this.changeFirebaseOrderStatus('delivered', 'any');
                    }
                }
            }
        }, (err) => {
    ...
    recalculateTotal() {
        ...
        if ((this.orderdetails.items && this.orderdetails.items.length > 0) || (this.orderdetails.combo && this.orderdetails.combo.length > 0) || (this.orderdetails.package && this.orderdetails.package.length > 0)) {
            if (typeof this.orderdetails['discount'] != 'undefined') {
                let totalAmt = this.orderdetails['subtotal'] - this.orderdetails['discount'];
...
GuestModalPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-login',template:/*ion-inline-start:"C:\KLproject\OrderSystem1\src\pages\login\guestlogin.html"*/'<ion-content padding text-center class="white backgroundImage" [ngStyle]="{\'background-image\': \'url(assets/imgs/login-bgImage.jpg)\'}">\n\n	<ion-avatar class="marginBottom4">\n\n        <img class="iconImage" [src]="iconImage()">\n\n    </ion-avatar>\n\n\n\n	<form role="form" [formGroup]="guestLoginForm" (ngSubmit)="login()" >	\n\n		<ion-item>\n\n			<ion-input formControlName="email" placeholder="Enter Email Address" type="text"></ion-input>\n\n		</ion-item>\n\n\n\n		<ion-row *ngIf="guestLoginForm.controls[\'email\'].touched && guestLoginForm.controls[\'email\'].dirty && guestLoginForm.controls[\'email\'].invalid " class="white padding8-16px">\n\n			Please enter a valid Email ID.\n\n		</ion-row>\n\n\n\n		<button ion-button class="themeRedBg" full [disabled]="!guestLoginForm.valid">Continue</button>\n\n\n\n\n\n		<ion-row>\n\n			<ion-col padding-top text-center col-12>\n\n				<span class="themeGreen" (click)="loginPage()">\n\n					<strong>Sign In</strong>\n\n				</span>\n\n			</ion-col>\n\n		</ion-row>\n\n	</form>\n\n	<!-- <button ion-button class="themeGreenBg" full (click)="loginPage()">Login</button> -->\n\n</ion-content>\n\n'/*ion-inline-end:"C:\KLproject\OrderSystem1\src\pages\login\guestlogin.html"*/,
    }),
    ...
    splicePackage(data) {
        ...
        data.forEach((pkg, index) => {
            if (pkg.type == 'fixed') {
                ...
                startDate.setDate(startDate.getDate() - this.priorDays);
...
AddOn = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'add-on',template:/*ion-inline-start:"C:\KLproject\OrderSystem1\src\pages\cart\add-on.html"*/'<ion-header>\n\n     \n\n    <ion-navbar>\n\n        \n\n        <ion-title>Add-On</ion-title>\n\n        <ion-buttons end>\n\n                <button ion-button icon-only (click)="cancel()">\n\n                    <ion-icon item-right name="ios-close-outline"></ion-icon>\n\n                </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content>\n\n    <div class="content-grid" style="margin-bottom: 10px;" *ngFor="let addOn of addOns">\n\n      <div class="obit-img">\n\n       \n\n        <img *ngIf="addOn.image" class="orderThumbnails" src="{{imageUrl}}/{{addOn.image}}" />\n\n      </div>\n\n      <h2>{{truck(addOn.name) }}</h2>\n\n      <div>{{truckDesc(addOn.description) }}</div>\n\n      <div>\n\n            Price :  {{addOn.finalprice  | number : \'1.1-2\'}} <b style="font-size: 9px;"> {{orderDetail.currency}} </b>\n\n      </div>\n\n      <span  class="input-group" style="padding: 7px 10px;">\n\n            Quantity : <input class="menuQty" type="number" name="" [value]="addOn.qty" min="0" #addOnQty (change) = "changeAddOns($event,addOnQty.value,addOn)" (keyup) = "changeAddOns($event,addOnQty.value,addOn)" style="width: 35px;border: 0;">\n\n         \n\n        </span>\n\n\n\n        <div>\n\n          <button [ngClass]="{\'display\':addOn.add}" ion-button class="green" (click)="addToCart(addOn)">  Add To Cart </button>\n\n          <button [ngClass]="{\'display\':!addOn.add}" class="red" ion-button (click)="removeToCart(addOn)">  Remove To Cart </button>\n\n        </div>      \n\n    </div>\n\n    <div style="text-align: center;">\n\n        <div>\n\n           <span> Sub Total :</span> <span>{{total | number : \'1.2-2\'}}</span>\n\n        </div>\n\n        <div>\n\n            <span> Add-On Total :</span> <span>{{addOnTotal | number : \'1.2-2\'}}</span>\n\n         </div>\n\n         <hr/>\n\n         <div>\n\n            <span> Total :</span> <span>{{totalWithAddOns| number : \'1.2-2\'}}</span>\n\n         </div>\n\n        <ion-row>\n\n        <button ion-button class="green" full style="width: 100%" (click)="addOnCart()">\n\n            Checkout \n\n        </button>\n\n    </ion-row>\n\n    </div>\n\n</ion-content>\n\n  '/*ion-inline-end:"C:\KLproject\OrderSystem1\src\pages\cart\add-on.html"*/
    }),
...
let AddCardsPage = class AddCardsPage {
    constructor(navCtrl, navParams, toastCtrl, loadingCtrl, ms3Service, ms4Service, lf) {
        ...
        this.cardForm = this.lf.group({
            cardtype: [],
            nameoncard: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required],
    ...
    addCard() {
        ...
        this.ms4Service.verifyCard(obj).subscribe((data) => {
            if (!data.error) {
                ...
                else if (typeof dataObj['ssl_result_message'] != 'undefined' && dataObj['ssl_result_message'] == 'APPROVAL') {
                    let index = this.currentCustomer['cardinfo'].findIndex((mn) => mn.cardnumber == foo2);
                    if (index == -1) {
                        this.cardForm.value["cardtype"] = dataObj['ssl_card_short_description'].toLowerCase();
                        let obj2 = this.cardForm.value;
                        ...
                        let obj22 = {};
                        obj22['_id'] = this.currentCustomer._id;
                        obj22['cardinfo'] = this.currentCustomer['cardinfo'];
                        this.updateCustomer(obj22);
                    }
                    else {
                        this.loading.dismiss();
                        this.getToast('Card with this Card Number already exist');
        ...
        /*(<any>window).Stripe.card.createToken({
            ...
            if (status === 200) {
                ...
                if (typeof response.card.brand != 'undefined' && response.card.brand != null) {
                    this.cardForm.controls["cardtype"].setValue(response.card.brand.toLowerCase());
                }
                ...
                if (index == -1) {
                    if (typeof this.editCardIndex != 'undefined') {
                        this.currentCustomer['cardinfo'][this.editCardIndex] = this.cardForm.value;
                        this.currentCustomer['cardinfo'][this.editCardIndex]['cardnumber'] = foo2;
                    }else{
                        let obj2 = this.cardForm.value;
                        obj2['cardnumber'] = foo2;
                        if (typeof this.currentCustomer['cardinfo'] == 'undefined') {
                    ...
                    obj['cardinfo'] = this.currentCustomer['cardinfo'];
    ...
    updateCustomer(obj) {
        this.ms3Service.updateCustomer(obj).subscribe((data) => {
            this.loading.dismiss();
            if (!data.error) {
                this.navCtrl.pop();
                if (typeof this.editCardIndex == 'undefined') {
                    ...
                    this.getToast('Card Detail Updated!');
                }
            }
            else {
                this.navCtrl.pop();
                if (typeof this.editCardIndex == 'undefined') {
                    ...
                    this.getToast('Unable to Update Card!');
                }
            }
        }, (err) => {
            this.getToast('Unable to add Card! Please check your Internet connection');
        });
    }
    choose(type) {
        console.log(this.cardForm.value);
...
let MyApp = class MyApp {
    ...
    initializeApp() {
        ...
        // this.clearBadge();
        this.pages = [
            { title: "All Chefs", component: __WEBPACK_IMPORTED_MODULE_6__pages_list_list__["a" /* ListPage */] },
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        handler: data => {
                            ...
                            this.pages = [];
                            this.pages.push({ title: "All Chefs", component: __WEBPACK_IMPORTED_MODULE_6__pages_list_list__["a" /* ListPage */] }, { title: "Cart", component: __WEBPACK_IMPORTED_MODULE_7__pages_cart_cart__["a" /* CartPage */] }, { title: "About", component: __WEBPACK_IMPORTED_MODULE_9__pages_info_info__["a" /* InfoPage */] }, { title: "Login", component: __WEBPACK_IMPORTED_MODULE_5__pages_login_login__["a" /* LoginPage */] });
                            this.getCurrentPage();
                        }
                    }
                ]
