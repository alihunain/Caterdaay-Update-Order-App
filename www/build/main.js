...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__filter__ = __webpack_require__(529);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_app_minimize__ = __webpack_require__(530);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__thankupage__ = __webpack_require__(386);
...
let CheckoutPage = class CheckoutPage {
    constructor(nav, navCtrl, navParams, toastCtrl, loadingCtrl, ms1Service, ms3Service, ms4Service, events, lf, modalCtrl, ele) {
        ...
        this.addressForm = this.lf.group({
            phoneno: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].pattern(patternq)]],
            // landline  : ['',[Validators.pattern(patternq)]],
            address: ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required],
            // landmark : [''],
            city: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].pattern('[a-zA-Z ]*')]],
            country: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].pattern('[a-zA-Z ]*')]],
            zipcode: ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required],
            _id: ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required]
        });
        ...
        this.cardForm = this.lf.group({
            ...
            cardnumber: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].minLength(16), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].maxLength(19), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].pattern('[0-9]{4}[ .\-]{0,1}[0-9]{4}[ .\-]{0,1}[0-9]{4}[ .\-]{0,1}[0-9]{4}')]],
            cvv: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].minLength(3), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].maxLength(3), __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].pattern('[0-9]{3}')]],
            expirymonth: ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required],
            expiryyear: ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required],
            zip: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].maxLength(9)]],
            address: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].maxLength(29)]],
            city: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].maxLength(29)]],
            state: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["f" /* Validators */].maxLength(29)]]
        });
        ...
        let currentDateUpdate = __WEBPACK_IMPORTED_MODULE_6_moment___default()(currentDate, "DD-MM-YYYY").add((Number(min) + 1), 'days').format("DD-MM-YYYY");
        let endDateUpdate = __WEBPACK_IMPORTED_MODULE_6_moment___default()(currentDate, "DD-MM-YYYY").add((Number(max)), 'days').format("DD-MM-YYYY");
    ...
    CheckingTimeValidationForFirst(init) {
        let FirstStartTime = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(this.delvierySlotsWeekSeleted.FirstStartTime), 'hh:mm');
        let FirstEndTime = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(this.delvierySlotsWeekSeleted.FirstEndTime), 'hh:mm');
        let ActualTime = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(init.value), 'hh:mm');
    ...
    CheckingTimeValidationForSecond(init) {
        ...
        console.log('Delivery Slot WeekSelected', __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(this.delvierySlotsWeekSeleted.SecondStartTime), 'hh:mm'));
        console.log(__WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(init.value), 'hh:mm'), 'Current TIME');
        let SecondStartTime = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(this.delvierySlotsWeekSeleted.SecondStartTime), 'hh:mm');
        let SecondEndTime = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(this.delvierySlotsWeekSeleted.SecondEndTime), 'hh:mm');
        let ActualTime = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(init.value), 'hh:mm');
    ...
    changeMinMaxOfWeekend(deliverySlot, init) {
        ...
        let StartTime = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(this.deliverySlotSelected.StartTime), 'hh:mm ');
        let EndTime = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(this.deliverySlotSelected.EndTime), 'hh:mm');
        let ActuallTime = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.convertTime12to24(init.value), 'hh:mm');
    ...
    laterFunction(type) {
        ...
        if (this.event.laterDay != '' && this.event.laterTime != '') {
            ...
            let date1 = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.event.laterDay + ' ' + this.event.laterTime).format('YYYY-MM-DD hh:mm A');
            this.datechecker = true;
    ...
    orderTimeFunction() {
        ...
        if (time == 'now') {
            ...
            let newDate = __WEBPACK_IMPORTED_MODULE_6_moment___default()(new Date).add(this.minTime, 'minutes').format('YYYY-MM-DD hh:mm A');
    ...
    caterdaaycharges() {
        return new Promise((resolve, reject) => {
            this.ms4Service.getCaterdaayCharges().subscribe((data) => {
    ...
    proceedToThank() {
        ...
        let nowDate = __WEBPACK_IMPORTED_MODULE_6_moment___default()().format('LLLL');
        let date1 = __WEBPACK_IMPORTED_MODULE_6_moment___default()(this.event.laterDay + ' ' + this.event.laterTime).format('YYYY-MM-DD hh:mm A');
        console.log(date1);
        date1 = __WEBPACK_IMPORTED_MODULE_6_moment___default()(date1).format('LLLL');
        console.log(date1);
    ...
    NotificationFunction(orderId, resId) {
        return new Promise((resolve, reject) => {
            this.ms1Service.getOne(resId).subscribe((data) => {
                ...
                this.ms1Service.Owner(data.message.ownerId).subscribe((res) => {
                    ...
                    this.ms1Service.Notification(data).subscribe((response) => {
                        let data2 = {
                            _id: ownerId,
    ...
    addNewOrder() {
        ...
        this.ms4Service.addOrder(this.orderdetails).subscribe((data) => {
            if (!data.error) {
                ...
                this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_3__thankupage__["a" /* ThankPage */], {
                    order: data.message,
...
CheckoutPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Nav */],
        ...
        __WEBPACK_IMPORTED_MODULE_5__app_service_index__["c" /* MS3Service */],
        __WEBPACK_IMPORTED_MODULE_5__app_service_index__["d" /* MS4Service */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__review_give_review__ = __webpack_require__(548);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_moment__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_moment__);
...
"use strict";
// export const imageUrlupload: string = 'https://www.mealdaay.com:4024/upload';
// export const url2: string = 'https://www.mealdaay.com:4024/';
// export const url3: string = 'https://www.mealdaay.com:4034/';
// export const imageUrl: string = 'https://www.mealdaay.com:4024/uploads/';
// export const imageUrl2: string = 'https://www.mealdaay.com:4004/uploads/';
// export const url: string = 'https://www.mealdaay.com:4004/';
// export const url1: string = 'https://www.mealdaay.com:4014/';
// export const url4: string = 'https://www.mealdaay.com:4044/';
...
const imageUrlupload = 'https://www.caterdaay.com:4024/upload';
/* unused harmony export imageUrlupload */

const url2 = 'https://www.caterdaay.com:4024/';
/* harmony export (immutable) */ __webpack_exports__["d"] = url2;

const url3 = 'https://www.caterdaay.com:4034/';
/* harmony export (immutable) */ __webpack_exports__["e"] = url3;

const imageUrl = 'https://www.caterdaay.com:4024/uploads/';
/* harmony export (immutable) */ __webpack_exports__["a"] = imageUrl;

const imageUrl2 = 'https://www.caterdaay.com:4004/uploads/';
/* unused harmony export imageUrl2 */

const url = 'https://www.caterdaay.com:4004/';
/* harmony export (immutable) */ __webpack_exports__["b"] = url;

const url1 = 'https://www.caterdaay.com:4014/';
/* harmony export (immutable) */ __webpack_exports__["c"] = url1;

const url4 = 'https://www.caterdaay.com:4044/';
/* harmony export (immutable) */ __webpack_exports__["f"] = url4;

// export const imageUrlupload: string = 'http://172.16.201.151:4024/upload';
// export const url2: string = 'http://172.16.201.151:4024/';
// export const url3: string = 'http://172.16.201.151:4034/';
...
// export const url: string = 'http://172.16.201.151:4004/';
// export const url1: string = 'http://172.16.201.151:4014/';
// export const url4: string = 'http://172.16.201.151:4044/';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_service_index__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__add_on__ = __webpack_require__(526);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_keyboard_ngx__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__my_pop_over__ = __webpack_require__(385);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__cart_cart__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__offer_offer__ = __webpack_require__(527);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__review_review__ = __webpack_require__(528);
...
let HomePage = class HomePage {
    ...
    //     });
    // }
    constructor(keyboard, navCtrl, events, navParams, 
        /*public popoverCtrl: PopoverController,*/
        loadingCtrl, menuCtrl, toastCtrl, alertCtrl, ms1Service, ms2Service, ms4Service, ms3Service, ms6Service, html) {
        this.keyboard = keyboard;
        this.navCtrl = navCtrl;
        this.events = events;
        this.navParams = navParams;
        ...
        this.imageURL = __WEBPACK_IMPORTED_MODULE_7__app_global__["a" /* imageUrl */];
        this.kitchen = {};
        this.data = [];
        this.cartItem = [];
        this.items = [];
    ...
    addToCartWeekend(weekend) {
        let saturday = {
            date: __WEBPACK_IMPORTED_MODULE_8_moment___default()(this.localDate).format('MM/DD/YYYY'),
            status: false,
            menuids: weekend.dayandmenus[0].menuids
        };
        let sunday = {
            date: __WEBPACK_IMPORTED_MODULE_8_moment___default()(this.formatted_date).format('MM/DD/YYYY'),
            status: false,
            menuids: weekend.dayandmenus[1].menuids
        };
        let tempwmenu = Object.assign({}, weekend);
        tempwmenu.startDate = __WEBPACK_IMPORTED_MODULE_8_moment___default()(this.localDate).format('YYYY-MM-DD');
        tempwmenu.endDate = __WEBPACK_IMPORTED_MODULE_8_moment___default()(this.formatted_date).format('YYYY-MM-DD');
    ...
    offerPage() {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__offer_offer__["a" /* OfferPage */], {
    ...
    presentPopover(event) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__my_pop_over__["a" /* MyPopOverPage */], {
...
HomePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__ionic_native_keyboard_ngx__["a" /* Keyboard */],
        ...
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* ToastController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
        __WEBPACK_IMPORTED_MODULE_9__app_service_index__["a" /* MS1Service */],
        __WEBPACK_IMPORTED_MODULE_9__app_service_index__["b" /* MS2Service */],
        __WEBPACK_IMPORTED_MODULE_9__app_service_index__["d" /* MS4Service */],
        __WEBPACK_IMPORTED_MODULE_9__app_service_index__["c" /* MS3Service */],
        __WEBPACK_IMPORTED_MODULE_9__app_service_index__["e" /* MS6Service */],
        __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]])
], HomePage);
...
MyPopOverPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-my-pop-over',template:/*ion-inline-start:"D:\Apps\OrderApp\src\pages\home\my-pop-over.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title>Basic Detail</ion-title>\n\n        <ion-icon  padding-horizontal margin-right class = "white" float-right end name="cart" ios="ios-cart" md="md-cart" (click)="cartPage()"></ion-icon>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding has-bouncing="true" >\n\n	<!-- <ion-item> --><!--  class="popover-page" -->\n\n\n\n		<!-- <ion-row *ngIf = "kitchen.openclose == \'close\' " class="openCloseDiv" text-center>\n\n        	<ion-col col-12 text-center text-uppercase> ** {{kitchen.openclose}} **</ion-col>\n\n        	<ion-col col-12 text-center>Your can Pre-order for later</ion-col>\n\n        </ion-row> -->\n\n\n\n		<!-- <ion-row class="whiteDiv" *ngIf = "kitchen.openinghours && kitchen.openinghours.length > 0">\n\n	        <ion-row class= "width100">\n\n	            <ion-col col-12><strong>Working Hours : </strong></ion-col>\n\n	        </ion-row>\n\n	        <hr class="width100 height2px">\n\n	        <ion-row padding-horizontal class= "width100">\n\n	        	<ion-col col-6><strong>Days</strong></ion-col>\n\n	        	<ion-col col-6><strong>Opening Hours</strong></ion-col>\n\n	        </ion-row>\n\n	        <ion-row *ngFor = "let eachday of kitchen.openinghours" class= "width100 paddingHorizontal6px">\n\n            	<ion-col col-5 text-capitalize><strong>{{eachday.name}}</strong></ion-col>\n\n	            <ion-col col-7>\n\n	            	<ion-row class = "width100" *ngFor = "let timeArr of eachday.times">\n\n	            		{{timeArr.open}} - {{timeArr.close}}\n\n	            	</ion-row>\n\n	            </ion-col>\n\n	        </ion-row>\n\n	    </ion-row> -->\n\n\n\n\n\n		<!-- <ion-row class="whiteDiv" *ngIf = "kitchen.minimumorder && kitchen.minimumorder != \'null\'"><strong>Min Order Amount : &nbsp; </strong><span *ngIf = "kitchen && kitchen.currency">{{kitchen.currency}} &nbsp;</span> {{kitchen.minimumorder}}</ion-row> -->\n\n\n\n		<!-- <ion-row class="whiteDiv" *ngIf = "kitchen.mindeliveryime && kitchen.mindeliveryime != \'null\'"><strong>Delivery Time : &nbsp; </strong>{{kitchen.preorderforlatertodays}} </ion-row> -->\n\n\n\n		<ion-row class="whiteDiv" *ngIf = "kitchen.preorderforlaterafterdays && kitchen.preorderforlaterafterdays != \'1\'"><strong>Pre-Order (Minimum Days) : </strong><span > &nbsp; After {{kitchen.preorderforlaterafterdays}} Days </span></ion-row>\n\n		<ion-row class="whiteDiv" *ngIf = "kitchen.preorderforlaterafterdays && kitchen.preorderforlaterafterdays == \'1\'"><strong>Pre-Order (Minimum Days) </strong><span > &nbsp; After {{kitchen.preorderforlaterafterdays}} Day </span></ion-row>\n\n		<ion-row class="whiteDiv" *ngIf = "kitchen.preorderforlatertodays"><strong>Pre-Order (Maximum Days) : &nbsp; </strong><span > Before {{kitchen.preorderforlatertodays}} Days </span></ion-row>\n\n		<!-- <ion-row class="whiteDiv" *ngIf = "kitchen.preorderforlater"><strong>Pre-Order for Later : &nbsp; </strong>Yes <span > &nbsp; (Before {{kitchen.preorderforlatertodays}} days) </span></ion-row> -->\n\n		\n\n		<!-- <ion-row class="whiteDiv" *ngIf = "!kitchen.preorderforlater"><strong>Pre-Order for Later : &nbsp; </strong>No</ion-row> -->\n\n		\n\n		<ion-row class="whiteDiv" *ngIf = "kitchen.restaurantMin != undefined"><strong>Catering Minimum Serving : &nbsp; </strong>{{kitchen.restaurantMin}}</ion-row>\n\n		<ion-row class="whiteDiv" *ngIf = "kitchen.restaurantMin != undefined"><strong>Catering Maximum Serving : &nbsp; </strong>{{kitchen.restaurantMax}}</ion-row>\n\n\n\n		<ion-row class="whiteDiv" *ngIf="cuisines && cuisines.length > 0"><strong>Cuisines : &nbsp; </strong><span *ngFor = "let cuisine of cuisines" text-capitalize> {{cuisine.name}},&nbsp; </span></ion-row>\n\n		\n\n		<ion-row class="whiteDiv" *ngIf="kitchen.offerings && kitchen.offerings.length > 0"><strong>Offerings : &nbsp; </strong><span *ngFor = "let offering of kitchen.offerings" text-capitalize> {{offering}},&nbsp; </span></ion-row>\n\n    <!-- </ion-item> -->\n\n</ion-content>'/*ion-inline-end:"D:\Apps\OrderApp\src\pages\home\my-pop-over.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* NavParams */]])
], MyPopOverPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ng2_file_upload__ = __webpack_require__(533);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ng2_file_upload___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_ng2_file_upload__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__changepassword__ = __webpack_require__(537);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__profileupdate__ = __webpack_require__(538);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__addaddress__ = __webpack_require__(539);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__addcards__ = __webpack_require__(540);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_service_index__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_file__ = __webpack_require__(541);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_transfer__ = __webpack_require__(542);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_file_path__ = __webpack_require__(543);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_camera__ = __webpack_require__(544);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let ChangePasswordPage = class ChangePasswordPage {
    ...
    passwordUpdate() {
        ...
        this.ms3Service.UpdatePass(obj4Update).subscribe((data) => {
            // if (!data.error) {
            // 	this.getCustomer(this.currentCustomer._id);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_global__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__contactus__ = __webpack_require__(546);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__cart_cart__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_service_index__ = __webpack_require__(14);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
InfoPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-info',template:/*ion-inline-start:"D:\Apps\OrderApp\src\pages\info\info.html"*/'<!--\n\nGenerated template for the InfoPage page.\n\n\n\nSee http://ionicframework.com/docs/components/#navigation for more info on\n\nIonic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n            <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n        <ion-title>About</ion-title>\n\n        <ion-icon padding-top padding-horizontal margin-right class="white" float-right end name="cart" ios="ios-cart" md="md-cart"\n\n            (click)="cartPage()">\n\n\n\n        </ion-icon>\n\n    </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding has-bouncing="true">\n\n    <ion-row class="desc" id="getData">\n\n        <section class="about-section container-fluid">\n\n            <div class="container">\n\n                <h1 class="text-center colorRed font60px marginBottom2em">About Us</h1>\n\n                <h1>Our Story</h1>\n\n                <!-- <h2 class="text-ligthsuccess marginBottom4rem">What made us start Caterdaay</h2> -->\n\n                <div class="row">\n\n                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 text-muted lineHeight2 font20px">Caterdaay was founded in 2016 in Toronto, Canada, and is the world’s largest marketplace for event catering.We\n\n                        make it simple to order food online for your office, parties, get-togethers and more. Caterdaay connects\n\n                        people with a network of reliable local caterers and restaurants across Canada. And we’re not just\n\n                        an elegant website. We feature a team of A-grade customer support professionals who are ready to\n\n                        help whenever and wherever. Caterdaay began with a handful of restaurants in Toronto. As our service\n\n                        matured, we expanded across Canada. Today, Caterdaay offers a curated list of the best business caterers\n\n                        for hundreds of cities and towns across Canada.</div>\n\n                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 text-muted lineHeight2 font20px">&nbsp;</div>\n\n                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 text-muted lineHeight2 font20px"><h2>Catering for All</h2></div>\n\n                 \n\n                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 text-muted lineHeight2 font20px">Whether you are looking for a caterer for a client meeting, wedding or birthday party, Caterdaay makes\n\n                        it effortless to order online from a vast catalogue of caterers accompanied by A-grade customer service.</div>\n\n                    <div class="col-lg-4 col-md-4 col-sm-3 hidden-xs text-center">\n\n                        <img class="rotate-90deg img-responsive" src="assets/image/chilli.png" />\n\n                    </div>\n\n                </div>\n\n                <div class="row mt-5 mb-5rem">\n\n                    <div class="col-lg-4 col-md-4 col-sm-3 hidden-xs text-center">\n\n                        <img class="img-responsive" src="assets/image/drawable-xxxhdpi-icon.png" />\n\n                    </div>\n\n                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">\n\n                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 marginVertical1-5rem lineHeight2 font20px text-muted">&nbsp;</div>\n\n                    </div>\n\n                </div>\n\n                \n\n\n\n            </div>\n\n            <h2>Save Time and Make It Simple</h2>\n\n            <div class="row">\n\n                <div class="text-muted font16px">Caterdaay ensures that you will never again need to hassle contacting restaurants and asking if they can\n\n                    deliver to your location. Instead, you can save valuable time and immediately identify caterers who not\n\n                    only serve to your address, but meet your food type, budget, dietary requirements and more. Best part\n\n                    of it all is that you can create, cancel or modify your orders anytime at all.</div>\n\n\n\n            </div>\n\n            <h2>How it Works</h2>\n\n            <div class="row">\n\n                   <i class="flaticon-salad"></i>\n\n                <div class="text-muted font16px">Discover caterers in your area that feature a variety of cuisines</div>\n\n                <i class="flaticon-shopping-cart"></i>\n\n                <div class="text-muted font16px">Add to cart and then select your order date & time</div>\n\n                  <i class="flaticon-fast-food"></i>\n\n                <div class="text-muted font16px">Enjoy your freshly made meals</div>\n\n\n\n            </div>\n\n        </section>\n\n        <section class="benefit-section container-fluid whiteWoodImage mb-5rem">\n\n            <div class="container" style="margin-top: 1.7rem !important;">\n\n                <h1 class="text-center marginBottom6rem">Benefits</h1>\n\n                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pt-5">\n\n                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">\n\n                        <h3 class=" font20px">For Who?</h3>\n\n                        <p class="text-muted font16px">Anyone who needs catering for a party, social event or corporate function.</p>\n\n                    </div>\n\n                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">\n\n                        <h3 class=" font20px">But Why?</h3>\n\n                        <p class="text-muted font16px">Convenient &amp; Time-saving, Fresh &amp; Delicious..&hellip; we could go on!</p>\n\n                    </div>\n\n                </div>\n\n                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pt-5">\n\n                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">\n\n                        <h3 class=" font20px">Eat What?</h3>\n\n                        <p class="text-muted font16px">Caterers offering cuisines from all across the world.</p>\n\n                    </div>\n\n                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">\n\n                        <h3 class=" font20px">How?</h3>\n\n                        <p class="text-muted font16px">Select which food items you want delivered.</p>\n\n                    </div>\n\n                </div>\n\n                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pt-5">\n\n                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">\n\n                        <h3 class=" font20px">Deliver When?</h3>\n\n                        <p class="text-muted font16px">Schedule your delivery at anytime. Even as much as a year in advance!</p>\n\n                    </div>\n\n                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">\n\n                        <h3 class=" font20px">And Where?</h3>\n\n                        <p class="text-muted font16px">Canada for now but our mission is worldwide!&hellip;</p>\n\n                    </div>\n\n                </div>\n\n                <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-0 col-xs-offset-0 col-lg-8 col-md-8 col-sm-12 col-xs-12 text-ligthsuccess font20px text-center padding15px marginVertical3rem">&nbsp;</div>\n\n            </div>\n\n        </section>\n\n        <!-- <section class="container-fluid now-section">\n\n            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">\n\n                <div class="turmericImage">\n\n                    <img class="width15em" src="assets/image/Spice.png" />\n\n                </div>\n\n                <div class="container">\n\n                    <h1 class="text-center mb-3">Now Available</h1>\n\n                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-5rem">\n\n                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-lg-8 col-md-8 col-sm-8 col-xs-12 text-center mb-5rem">\n\n                            <h4 class="text-muted font20px">Download our Caterdaay App Today</h4>\n\n                        </div>\n\n                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center mb-5rem">\n\n                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">\n\n                                <img class="img-responsive pull-right width12em" src="assets/image/appstore.png" />\n\n                            </div>\n\n                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">\n\n                                <img class="img-responsive pull-left width12em" src="assets/image/googleplay.png" />\n\n                            </div>\n\n                        </div>\n\n                    </div>\n\n                </div>\n\n            </div>\n\n        </section> -->\n\n    </ion-row>\n\n\n\n    <ion-row>\n\n        <button ion-button full class="contactUsButton" (click)="contactUsPage()">Contact us?</button>\n\n    </ion-row>\n\n</ion-content>'/*ion-inline-end:"D:\Apps\OrderApp\src\pages\info\info.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_5__app_service_index__["a" /* MS1Service */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_home_my_pop_over__ = __webpack_require__(385);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_list_filter__ = __webpack_require__(529);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_cart_thankupage__ = __webpack_require__(386);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ionic_native_app_minimize__ = __webpack_require__(530);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_profile_profile__ = __webpack_require__(532);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_profile_changepassword__ = __webpack_require__(537);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_profile_profileupdate__ = __webpack_require__(538);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_profile_addaddress__ = __webpack_require__(539);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_profile_addcards__ = __webpack_require__(540);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_order_order__ = __webpack_require__(547);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_review_review__ = __webpack_require__(528);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_review_give_review__ = __webpack_require__(548);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_info_info__ = __webpack_require__(545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_info_contactus__ = __webpack_require__(546);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_wishlist_wishlist__ = __webpack_require__(914);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__pages_offer_offer__ = __webpack_require__(527);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_snap_snap__ = __webpack_require__(915);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__ionic_native_network__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38_ionic2_rating__ = __webpack_require__(916);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39_ng2_file_upload__ = __webpack_require__(533);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__service_firebase_function_service__ = __webpack_require__(531);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__ionic_native_file__ = __webpack_require__(541);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__ionic_native_transfer__ = __webpack_require__(542);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__ionic_native_file_path__ = __webpack_require__(543);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__ionic_native_camera__ = __webpack_require__(544);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__ionic_native_keyboard_ngx__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__ionic_native_geolocation__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51_angularfire2__ = __webpack_require__(918);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51_angularfire2___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_51_angularfire2__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52_angularfire2_database__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52_angularfire2_database___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_52_angularfire2_database__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53_angularfire2_firestore__ = __webpack_require__(919);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53_angularfire2_firestore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_53_angularfire2_firestore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_54_angularfire2_auth__ = __webpack_require__(924);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_54_angularfire2_auth___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_54_angularfire2_auth__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_55__ionic_native_badge__ = __webpack_require__(549);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_56_firebase__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_57_ion2_datetime_picker__ = __webpack_require__(929);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_58__pages_cart_add_on__ = __webpack_require__(526);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__WEBPACK_IMPORTED_MODULE_56_firebase__["initializeApp"](config);
let AppModule = class AppModule {
};
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_58__pages_cart_add_on__["a" /* AddOn */],
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_57_ion2_datetime_picker__["a" /* MultiPickerModule */],
            ...
            __WEBPACK_IMPORTED_MODULE_51_angularfire2__["AngularFireModule"].initializeApp(config),
            __WEBPACK_IMPORTED_MODULE_52_angularfire2_database__["AngularFireDatabaseModule"],
            __WEBPACK_IMPORTED_MODULE_53_angularfire2_firestore__["AngularFirestoreModule"],
            __WEBPACK_IMPORTED_MODULE_54_angularfire2_auth__["AngularFireAuthModule"]
        ],
        ...
        providers: [
            // CallNumber,
            __WEBPACK_IMPORTED_MODULE_55__ionic_native_badge__["a" /* Badge */],
            ...
            __WEBPACK_IMPORTED_MODULE_52_angularfire2_database__["AngularFireDatabase"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_profile_profile__ = __webpack_require__(532);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_info_info__ = __webpack_require__(545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_order_order__ = __webpack_require__(547);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_order_orderdetail__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__service_index__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__service_location_service__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_badge__ = __webpack_require__(549);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_native_diagnostic__ = __webpack_require__(172);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let MyApp = class MyApp {
    constructor(platform, 
        ...
        threeService, app, statusBar, events, splashScreen, alertCtrl, ms4Service, ms6Service, locationService, loadingCtrl, toastCtrl, badge, diagnostic, 
        /*private backgroundMode: BackgroundMode,*/
        network) {
        this.platform = platform;
    ...
    initializeApp() {
        ...
        // this.clearBadge();
        this.pages = [
            { title: "All Caterers", component: __WEBPACK_IMPORTED_MODULE_6__pages_list_list__["a" /* ListPage */] },
                        ...
                        handler: data => {
                            this.UpdateToken().then((res) => {
                                this.threeService.updateCustomer(res).subscribe(() => {
                                    ...
                                    this.pages = [];
                                    this.pages.push({ title: "All Caterers", component: __WEBPACK_IMPORTED_MODULE_6__pages_list_list__["a" /* ListPage */] }, { title: "Cart", component: __WEBPACK_IMPORTED_MODULE_7__pages_cart_cart__["a" /* CartPage */] }, { title: "About", component: __WEBPACK_IMPORTED_MODULE_9__pages_info_info__["a" /* InfoPage */] }, { title: "Login", component: __WEBPACK_IMPORTED_MODULE_5__pages_login_login__["a" /* LoginPage */] });
                                    this.getCurrentPage();
                                });
                            });
...
let MS1Service = class MS1Service {
    constructor(http) {
        this.http = http;
        this.LoginElement = new __WEBPACK_IMPORTED_MODULE_2_rxjs__["Subject"]();
        this.getLoginElement = this.LoginElement.asObservable();
    }
    UpdateCart(ele) {
    ...
    Owner(id) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_3__global__["c" /* url1 */] + "owners/" + id).map((response) => response.json());
    }
    Notification(data) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_3__global__["c" /* url1 */] + "notifications", data).map((response) => response.json());
    }
    editOwner(data) {
        return this.http.put(__WEBPACK_IMPORTED_MODULE_3__global__["c" /* url1 */] + 'owners/' + data._id, data)
            .map((response) => response.json());
    }
    getOneOwner(id) {
...
let MS3Service = class MS3Service {
    ...
    UpdatePass(obj) {
        return this.http.put(__WEBPACK_IMPORTED_MODULE_3__global__["e" /* url3 */] + "customers/change-password/" + obj._id, obj).map((response) => {
            response.json();
        });
    }
    getOneCustomer(id) {
...
let MS4Service = class MS4Service {
    ...
    getCaterdaayCharges() {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_3__global__["b" /* url */] + 'mealdaaycharges').map((response) => response.json());
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_service_firebase_function_service__ = __webpack_require__(531);
